...
Here is the link to the [Hello Rails Front-End](https://github.com/sadaf-Daneshgar/hello-react-front-end/pull/1)repository.
...
```sh
git clone https://github.com/sadaf-Daneshgar/hello-rails-back-end.git
...
Contributions, issues, and feature requests are welcome! Feel free to check the [issues page](https://github.com/sadaf-Daneshgar/hello-rails-back-end/issues).
